...
@interface CS_AnswerMultiSelection_TVC()<VIPhotoViewDelegate>

@end

@implementation CS_AnswerMultiSelection_TVC
...
- (void)configureLayoutFor:(UITableView*)tableView usingElement:(CustomSurveyCollectionElement*)element atIndex:(NSIndexPath*)indexPath
{
    ...
    if (selected){
        ...
        imvRadioButton.image = [UIImage imageNamed:@"CustomSurveyIconCheckButtonSelected"];
    }else{
        [lblText setFont:[UIFont fontWithName:FONT_DEFAULT_REGULAR size:FONT_SIZE_BUTTON_MENU_OPTION]];
        imvRadioButton.image = [UIImage imageNamed:@"CustomSurveyIconCheckButtonNormal"];
    }
