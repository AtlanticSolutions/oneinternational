...
//  LAB360-ObjC
//
//  Created by Erico GT on 18/07/18.
//  Copyright © 2018 Atlantic Solutions. All rights reserved.
//

#pragma mark - • HEADER IMPORT
#import "Viewer3DMainVC.h"
...
@interface Viewer3DMainVC ()<FloatingPickerViewDelegate, VirtualSceneViewerDelegate, InternetConnectionManagerDelegate>
...
@synthesize btnOBJ1, btnOBJ2, btnOBJ3, btnOBJ4, btnOBJ5, btnOBJ6, btnOBJReabrir, segCameraControl, lblCameraControl, slider, lblZoomValue, swtEmission, lblEmission;
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"SegueTo3DViewer"]){
        ...
        vc.maxZoomAlowed = 5.0;
        vc.sceneQuality = Virtual3DViewerSceneQualityUltra;
...
- (IBAction)actionHelp:(id)sender
{
    ...
    [alert showInfo:@"Nota" subTitle:@"Faça o upload dos arquivos para teste no endereço <https://s3-sa-east-1.amazonaws.com/ad-alive.com/downloads/lab360/objects3D/obj1.zip>, nomeando corretamente o zip com o número correspondente (1~6)." closeButtonTitle:@"OK" duration:0.0];
}
...
- (NSArray<UIImage*>*)virtualSceneViewer:(VirtualSceneViewerVC*)sceneViewer enviromentImagesForScene:(NSInteger)sceneIndex
{
    ...
    NSString *imageName = [NSString stringWithFormat:@"virtual-skybox-enviroment-scene-%i.jpg", (sceneIndex + 1)];
...
{
    return VirtualSceneViewerInstructionStyleHide;
}
...
{
    return @"Rotacione o objeto para ver seus detalhes. Você também pode ampliá-lo.";
}
...
- (void)downloadOBJWithID:(NSInteger)objID
{
    ...
    if (iType == InternetActiveConnectionTypeWiFi || iType == InternetActiveConnectionTypeCellData){
        ...
        NSString *objURL = [NSString stringWithFormat:@"https://s3-sa-east-1.amazonaws.com/ad-alive.com/downloads/lab360/objects3D/obj%li.zip", (long)objID];
