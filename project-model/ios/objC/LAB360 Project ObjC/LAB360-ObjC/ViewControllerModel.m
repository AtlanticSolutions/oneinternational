...
@synthesize setupOnceInViewWillAppear, showAppMenu, setupExecuted, animatedTransitions; //pushAnimation, popAnimation;
...
- (void) commonInit {
    ...
    //
    //pushAnimation = NavigationControllerTransitionAnimationDefault;
    //popAnimation = NavigationControllerTransitionAnimationDefault;
}
...
//            
//            if (self.pushAnimation == NavigationControllerTransitionAnimationFade){
...
//            
//            if (self.popAnimation == NavigationControllerTransitionAnimationFade){
//                return [FadePushAnimator new];
//            }else{
//                return nil;
//            }
        ...
        if ([self.presentingViewController presentedViewController] == self) {
            ...
            if (indexesToReturn == 0) {
                ...
                if (actualIndex -  indexesToReturn <= 0) {
                    ...
                    [self.navigationController popToViewController:([self.navigationController.viewControllers objectAtIndex:(actualIndex -  indexesToReturn)]) animated:YES];
                }
            }
        }
    });
...
{
    //NSLog(@"keyboardWillAppearAlert-baseClass");
    return;
}

- (void)keyboardWillHideAlert
{
    //NSLog(@"keyboardWillHideAlert-baseClass");
    return;
}
