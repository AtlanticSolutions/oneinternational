...
public class CustomSwipeToRefreshLayout extends SwipeRefreshLayout {

    private View[] mSwipeableChildren;

    public CustomSwipeToRefreshLayout(Context context) {
        super(context);
    }

    public CustomSwipeToRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
