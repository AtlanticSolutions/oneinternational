package br.com.lab360.oneinternacional.ui.activity.video360;
...
public class SphericalSceneRenderer {
    ...
    public SphericalSceneRenderer(Context context) {
        shaderProgram = new ShaderProgram(
                Video360Activity.readRawTextFile(context, R.raw.video_vertex_shader),
                Video360Activity.readRawTextFile(context, R.raw.video_fragment_shader));
