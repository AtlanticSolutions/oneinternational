...
public class AnimationPromotionalCard extends View {
    ...
    public AnimationPromotionalCard (Context context) {
        this(context, null);
    }

    public AnimationPromotionalCard (Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnimationPromotionalCard (Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public AnimationPromotionalCard setImages(Drawable image){
        images = new Drawable[1];
        images[0] = resize(image);
        return this;
    }

    public AnimationPromotionalCard start(){
    ...
    private class Notes {
        ...
        private void init() {
            ...
            */
            alpha = 255; //get a random Aplha 55~255
            scale = 1.0f;  //random Sizes 0.5~1.5
